...
% NT: Consider making this simpler so as not to combine a shifty-looking constant with a shift. (see P1-back)
...
% NT: There are multiple solutions (sin(2t-4)?) Tidy this up.
