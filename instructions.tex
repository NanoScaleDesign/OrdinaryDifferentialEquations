...
Note that $P$ is only calculated from 21 October. If $N - F \le 2$ then $F$ is treated as being equal to $N$ (ie, you can forget twice). You can be counted as attending the class even if you are not present if the reason for not attending is unavoidable (eg, health reasons) and you inform the teacher in advance.

Grades will be assigned following the Kyushu University grading system:
\begin{itemize}
