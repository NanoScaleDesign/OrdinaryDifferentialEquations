...
\newcommand{\solstr}[2]{X = Your solution\\Form: String.\\Place the indicated letter in front of the string.\\Example: aX where $X=abcdef$ is entered as \href{http://www.wolframalpha.com/input/?i=md5+hash+of+\%22a46.00\%22}{aabcdef}\\\\Hash of {#1}X = {#2}}
...
\input{hash}
\section{Coursework}
Coursework information will be placed here at a later date.
%\input{coursework}
